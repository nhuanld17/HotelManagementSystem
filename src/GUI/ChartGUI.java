...
public class ChartGUI extends JFrame {
    public ChartGUI() {
        ...
        JFreeChart chart = ChartFactory.createLineChart(
                "Doanh thu theo từng ngày", // Tiêu đề biểu đồ
                "Ngày", // Đơn vị trục x
        ...
        xAxis.setCategoryLabelPositions(CategoryLabelPositions.UP_90); // đặt góc của nhãn x hướng lên 45 độ
    ...
    private CategoryDataset createDataset() {
        ...
        ArrayList<Chart> charts = new HoaDonBUS().getChart(); // Lấy Arlist
